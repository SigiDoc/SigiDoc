...
<!-- $Id$ -->
<xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:t="http://www.tei-c.org/ns/1.0" exclude-result-prefixes="t" version="2.0" xmlns:fn="http://www.w3.org/2005/xpath-functions">
  ...
  <xsl:template name="sigidoc-body-structure">
    ...
    <h6 width="600" align="right" xml:space="preserve">
      SigiDoc ID:
      <xsl:choose>
    ...
    <div id="stone">
      <h3 class="iospe">
        <i18n:text i18n:key="epidoc-xslt-sigidoc-artifact">Artifact</i18n:text>
      </h3>
      <dl class="iospe">
        <dt width="150" align="left">
          <i18n:text i18n:key="epidoc-xslt-sigidoc-type">Type</i18n:text>
        </dt>
        <dd>
          <xsl:choose>
            ...
            <xsl:otherwise>
              <i18n:text i18n:key="epidoc-xslt-sigidoc-seal">Seal</i18n:text>
            </xsl:otherwise>
          </xsl:choose>
        </dd>
        <dt width="150" align="left">
          <i18n:text i18n:key="epidoc-xslt-sigidoc-general-layout">General layout</i18n:text>
        </dt>
        <dd>
          <xsl:choose>
        ...
        <dt width="150" align="left">
          <i18n:text i18n:key="epidoc-xslt-sigidoc-matrix">Matrix</i18n:text>
        </dt>
        <dd>
            ...
            <xsl:when test="//t:layout[@n='whole']//t:rs[@type='matrix'][@subtype='surviving']">
              <xsl:choose>
                <xsl:when test="//t:layout[@n='whole']//t:rs[@type='matrix'][@subtype='surviving']//t:idno[@type='SigiDoc'] and //t:layout[@n='whole']//t:rs[@type='matrix'][@subtype='surviving']//t:idno[@type='PBW']">
                  SigiDoc ID:
                  <xsl:apply-templates select="//t:layout[@n='whole']//t:rs[@type='matrix'][@subtype='surviving']//t:idno[@type='SigiDoc']" />
                  * - PBW ID:
                  <xsl:apply-templates select="//t:layout[@n='whole']//t:rs[@type='matrix'][@subtype='surviving']//t:idno[@type='PBW']" />
                  *
                </xsl:when>
            ...
            <xsl:when test="//t:layout[@n='whole']//t:rs[@type='matrix'][@subtype='notSurviving']">
              <xsl:choose>
                <xsl:when test="//t:layout[@n='whole']//t:rs[@type='matrix'][@subtype='notSurviving']//t:idno[@type='SigiDoc'] and //t:layout[@n='whole']//t:rs[@type='matrix'][@subtype='notSurviving']//t:idno[@type='PBW']">
                  SigiDoc ID:
                  <xsl:apply-templates select="//t:layout[@n='whole']//t:rs[@type='matrix'][@subtype='notSurviving']//t:idno[@type='SigiDoc']" />
                  - PBW ID:
                  <xsl:apply-templates select="//t:layout[@n='whole']//t:rs[@type='matrix'][@subtype='notSurviving']//t:idno[@type='PBW']" />
                </xsl:when>
    ...
    <div id="stone">
      <h4 class="iospe">
        <i>
          <i18n:text i18n:key="epidoc-xslt-sigidoc-physical-description">Physical description</i18n:text>
        </i>
      </h4> <!-- ************* physical description *************** -->
      <dl class="iospe">
        <dt width="150" align="left">
          <i18n:text i18n:key="epidoc-xslt-sigidoc-work-type">Impression type</i18n:text>
        </dt>
        <dd>
          <xsl:choose>
            ...
            <xsl:otherwise>
              <i18n:text i18n:key="epidoc-xslt-sigidoc-original-impression">Original impression</i18n:text>
            </xsl:otherwise>
          </xsl:choose>
        </dd>
        <dt width="150" align="left">
          <i18n:text i18n:key="epidoc-xslt-sigidoc-material">Material</i18n:text>
        </dt>
        <dd>
          <xsl:choose>
            ...
            <xsl:otherwise>
              <i18n:text i18n:key="epidoc-xslt-sigidoc-lead">Lead</i18n:text>
            </xsl:otherwise>
          </xsl:choose>
        </dd>
        <dt width="150" align="left">
          <i18n:text i18n:key="epidoc-xslt-sigidoc-dimensions">Dimensions (mm)</i18n:text>
        </dt>
        <dd>
          <xsl:choose xml:space="preserve">
        ...
        <dt width="150" align="left">
          <i18n:text i18n:key="epidoc-xslt-sigidoc-weight">Weight (g)</i18n:text>
        </dt>
        <dd>
          <xsl:choose>
        ...
        <dt width="150" align="left">
          <i18n:text i18n:key="epidoc-xslt-sigidoc-axis">Axis (clock)</i18n:text>
        </dt>
        <dd>
          <xsl:choose>
        ...
        <dt width="150" align="left">
          <i18n:text i18n:key="epidoc-xslt-sigidoc-overstrike-orientation">Overstrike orientation (clock)</i18n:text>
        </dt>
        <dd>
          <xsl:choose>
            ...
            <xsl:otherwise>
              <i>
                <i18n:text i18n:key="epidoc-xslt-sigidoc-not-applicable">Not applicable</i18n:text>
              </i>
            </xsl:otherwise>
          </xsl:choose>
        </dd>
        <dt width="150" align="left">
          <i18n:text i18n:key="epidoc-xslt-sigidoc-channel-orientation">Channel orientation (clock)</i18n:text>
        </dt>
        <dd>
          <xsl:choose>
        ...
        <dt width="150" align="left">
          <i18n:text i18n:key="epidoc-xslt-sigidoc-execution">Execution</i18n:text>
        </dt>
        <dd>
          <xsl:choose>
            ...
            <xsl:otherwise>
              <i18n:text i18n:key="epidoc-xslt-sigidoc-struck">Struck</i18n:text>
            </xsl:otherwise>
          </xsl:choose>
        </dd>
        <dt width="150" align="left">
          <i18n:text i18n:key="epidoc-xslt-sigidoc-countermark">Countermark</i18n:text>
        </dt>
        <dd>
          <xsl:choose>
            ...
            <xsl:otherwise>
              <i>
                <i18n:text i18n:key="epidoc-xslt-sigidoc-none">None</i18n:text>
              </i>
            </xsl:otherwise>
          </xsl:choose>
        </dd>
        <dt width="150" align="left">
          <i18n:text i18n:key="epidoc-xslt-sigidoc-lettering">Lettering</i18n:text>
        </dt>
        <dd id="lettering">
          <xsl:choose>
        ...
        <dt width="150" align="left">
          <i18n:text i18n:key="epidoc-xslt-sigidoc-shape">Shape</i18n:text>
        </dt>
        <dd>
          <xsl:choose>
            ...
            <xsl:otherwise>
              <i18n:text i18n:key="epidoc-xslt-sigidoc-round">Round</i18n:text>
            </xsl:otherwise>
          </xsl:choose>
        </dd>
        <dt width="150" align="left">
          <i18n:text i18n:key="epidoc-xslt-sigidoc-condition">Condition</i18n:text>
        </dt>
        <dd>
          <xsl:choose xml:space="preserve">
    ...
    <div id="stone">
      <h4 class="iospe">
        <i>
          <i18n:text i18n:key="epidoc-xslt-sigidoc-dating">Dating</i18n:text>
        </i>
      </h4> <!-- ***********Dating************ -->
      <dl class="iospe">
        <dt width="150" align="left">
          <i18n:text i18n:key="epidoc-xslt-sigidoc-date">Date</i18n:text>
        </dt>
        <dd>
          <xsl:choose>
        ...
        <dt width="150" align="left">
          <i18n:text i18n:key="epidoc-xslt-sigidoc-internal-date">Internal date</i18n:text>
        </dt>
        <dd>
          <xsl:choose>
        ...
        <dt width="150" align="left">
          <i18n:text i18n:key="epidoc-xslt-sigidoc-dating-criteria">Dating criteria</i18n:text>
        </dt>
        <dd>
          <xsl:choose>
          ...
          <!-- NOT TO BE CHANGED INTO <xsl:apply-templates/> -->
        </dd>
        <dt width="150" align="left">
          <i18n:text i18n:key="epidoc-xslt-sigidoc-alternative-dating">Alternative dating</i18n:text>
        </dt>
        <dd>
          <xsl:choose>
            <xsl:when test="//t:origin//t:date//t:choice">
              <xsl:apply-templates select="//t:origin//t:date//t:choice//t:corr" />
              (
              <xsl:apply-templates select="//t:origin//t:date//t:choice//t:corr/@resp" />
              )
            </xsl:when>
            <xsl:otherwise>
              <i>―</i>
    ...
    <div id="stone">
      <h4 class="iospe">
        <i>
          <i18n:text i18n:key="epidoc-xslt-sigidoc-history">History</i18n:text>
        </i>
      </h4> <!-- ***********History********* -->
      <dl class="iospe">
        <dt width="150" align="left">
          <i18n:text i18n:key="epidoc-xslt-sigidoc-seal-context">Seal's context</i18n:text>
        </dt>
        <dd>
          <xsl:choose>
        ...
        <dt width="150" align="left">
          <i18n:text i18n:key="epidoc-xslt-sigidoc-issuer">Issuer</i18n:text>
        </dt>
        <dd>
          <xsl:choose>
        ...
        <dt width="150" align="left">
          <i18n:text i18n:key="epidoc-xslt-sigidoc-issuer-milieu">Issuer's milieu</i18n:text>
        </dt>
        <dd>
          <xsl:choose>
        ...
        <dt width="150" align="left">
          <i18n:text i18n:key="epidoc-xslt-sigidoc-place-origin">Place of origin</i18n:text>
        </dt>
        <dd>
          <xsl:choose>
        ...
        <dt width="150" align="left">
          <i18n:text i18n:key="epidoc-xslt-sigidoc-find-place">Find place</i18n:text>
        </dt>
        <dd>
          <xsl:choose xml:space="preserve">
        ...
        <dt width="150" align="left">
          <i18n:text i18n:key="epidoc-xslt-sigidoc-find-date">Find date</i18n:text>
        </dt>
        <dd>
          <xsl:choose xml:space="preserve">
            ...
            <xsl:when test="//t:provenance[@type='found']/@notBefore and //t:provenance[@type='found']/@notAfter">
              <xsl:apply-templates select="//t:provenance[@type='found']/@notBefore" />
              -
              <xsl:apply-templates select="//t:provenance[@type='found']/@notAfter" />
            </xsl:when>
            <xsl:when test="//t:provenance[@type='found']/@notBefore">
              <i18n:text i18n:key="epidoc-xslt-sigidoc-not-before">Not before</i18n:text>
              <xsl:apply-templates select="//t:provenance[@type='found']/@notBefore" />
            </xsl:when>
            <xsl:when test="//t:provenance[@type='found']/@notAfter">
              <i18n:text i18n:key="epidoc-xslt-sigidoc-not-after">Not after</i18n:text>
              <xsl:apply-templates select="//t:provenance[@type='found']/@notAfter" />
            </xsl:when>
            <xsl:otherwise>
              <i>―</i>
        ...
        <dt width="150" align="left">
          <i18n:text i18n:key="epidoc-xslt-sigidoc-find-circumstances">Find circumstances</i18n:text>
        </dt>
        <dd>
          <xsl:choose>
        ...
        <dt width="150" align="left">
          <i18n:text i18n:key="epidoc-xslt-sigidoc-modern-location">Modern location</i18n:text>
        </dt>
        <dd>
          <xsl:choose xml:space="preserve">
        ...
        <dt width="150" align="left">
          <i18n:text i18n:key="epidoc-xslt-sigidoc-institution-repository">Institution and repository</i18n:text>
        </dt>
        <!-- <dd>
            <xsl:choose xml:space="preserve">
        ...
        <dt width="150" align="left">
          <i18n:text i18n:key="epidoc-xslt-sigidoc-collection-inventory">Collection and inventory</i18n:text>
        </dt>
        <dd>
          <xsl:choose xml:space="preserve">
        ...
        <dt width="150" align="left">
          <i18n:text i18n:key="epidoc-xslt-sigidoc-acquisition">Acquisition</i18n:text>
        </dt>
        <dd>
          <xsl:choose xml:space="preserve">
        ...
        <dt width="150" align="left">
          <i18n:text i18n:key="epidoc-xslt-sigidoc-previous-locations">Previous locations</i18n:text>
        </dt>
        <dd>
          <xsl:choose xml:space="preserve">
        ...
        <dt width="150" align="left">
          <i18n:text i18n:key="epidoc-xslt-sigidoc-modern-observations">Modern observations</i18n:text>
        </dt>
        <dd>
          <xsl:choose>
    ...
    <div id="text-field">
      <h3 class="iospe">
        <i18n:text i18n:key="epidoc-xslt-sigidoc-field-obverse">Inscribed field - Obverse</i18n:text>
      </h3> <!-- *******inscribed field - obverse *********** -->
      <dl class="iospe">
        <dt width="150" align="left">
          <i18n:text i18n:key="epidoc-xslt-sigidoc-layout-field">Layout of field</i18n:text>
        </dt>
        <dd>
          <xsl:choose xml:space="preserve">
            ...
            <xsl:otherwise>
              <i>
                <i18n:text i18n:key="epidoc-xslt-sigidoc-undetermined">Undetermined</i18n:text>
              </i>
            </xsl:otherwise>
          </xsl:choose>
        </dd>
        <dt width="150" align="left">
          <i18n:text i18n:key="epidoc-xslt-sigidoc-field-dimensions">Field's dimensions (mm)</i18n:text>
        </dt>
        <dd>
          <xsl:choose xml:space="preserve">
            ...
            <xsl:when test="//t:layout[@n='r']//t:rs[@type='matrix'][@subtype='surviving']">
              <xsl:choose>
                <xsl:when test="//t:layout[@n='r']//t:rs[@type='matrix'][@subtype='surviving']//t:idno[@type='SigiDoc'] and //t:layout[@n='r']//t:rs[@type='matrix'][@subtype='surviving']//t:idno[@type='PBW']">
                  SigiDoc ID:
                  <xsl:apply-templates select="//t:layout[@n='r']//t:rs[@type='matrix'][@subtype='surviving']//t:idno[@type='SigiDoc']//text()" />
                  * - PBW ID:
                  <xsl:apply-templates select="//t:layout[@n='r']//t:rs[@type='matrix'][@subtype='surviving']//t:idno[@type='PBW']//text()" />
                  *
                </xsl:when>
            ...
            <xsl:when test="//t:layout[@n='r']//t:rs[@type='matrix'][@subtype='notSurviving']">
              <xsl:choose xml:space="preserve">
                <xsl:when test="//t:layout[@n='r']//t:rs[@type='matrix'][@subtype='notSurviving']//t:idno[@type='SigiDoc'] and //t:layout[@n='r']//t:rs[@type='matrix'][@subtype='notSurviving']//t:idno[@type='PBW']">
                  SigiDoc ID:
                  <xsl:apply-templates select="//t:layout[@n='r']//t:rs[@type='matrix'][@subtype='notSurviving']//t:idno[@type='SigiDoc']//text()" />
                  - PBW ID:
                  <xsl:apply-templates select="//t:layout[@n='r']//t:rs[@type='matrix'][@subtype='notSurviving']//t:idno[@type='PBW']//text()" />
                </xsl:when>
        ...
        <dt width="150" align="left">
          <i18n:text i18n:key="epidoc-xslt-sigidoc-iconography">Iconography</i18n:text>
        </dt>
        <dd>
          <xsl:choose>
        ...
        <dt width="150" align="left">
          <i18n:text i18n:key="epidoc-xslt-sigidoc-decoration">Decoration</i18n:text>
        </dt>
        <dd>
          <xsl:choose>
    ...
    <div id="text-field">
      <h3 class="iospe">
        <i18n:text i18n:key="epidoc-xslt-sigidoc-field-reverse">Inscribed field - Reverse</i18n:text>
            ...
            <xsl:when test="//t:layout[@n='v']//t:rs[@type='matrix'][@subtype='surviving']">
              <xsl:choose>
                <xsl:when test="//t:layout[@n='v']//t:rs[@type='matrix'][@subtype='surviving']//t:idno[@type='SigiDoc'] and //t:layout[@n='v']//t:rs[@type='matrix'][@subtype='surviving']//t:idno[@type='PBW']">
                  SigiDoc ID:
                  <xsl:apply-templates select="//t:layout[@n='v']//t:rs[@type='matrix'][@subtype='surviving']//t:idno[@type='SigiDoc']//text()" />
                  * - PBW ID:
                  <xsl:apply-templates select="//t:layout[@n='v']//t:rs[@type='matrix'][@subtype='surviving']//t:idno[@type='PBW']//text()" />
                  *
                </xsl:when>
            ...
            <xsl:when test="//t:layout[@n='v']//t:rs[@type='matrix'][@subtype='notSurviving']">
              <xsl:choose xml:space="preserve">
                <xsl:when test="//t:layout[@n='v']//t:rs[@type='matrix'][@subtype='notSurviving']//t:idno[@type='SigiDoc'] and //t:layout[@n='v']//t:rs[@type='matrix'][@subtype='notSurviving']//t:idno[@type='PBW']">
                  SigiDoc ID:
                  <xsl:apply-templates select="//t:layout[@n='v']//t:rs[@type='matrix'][@subtype='notSurviving']//t:idno[@type='SigiDoc']//text()" />
                  - PBW ID:
                  <xsl:apply-templates select="//t:layout[@n='v']//t:rs[@type='matrix'][@subtype='notSurviving']//t:idno[@type='PBW']//text()" />
                </xsl:when>
    ...
    <div id="text">
      <h3 class="iospe">
        <i18n:text i18n:key="epidoc-xslt-sigidoc-text">Text</i18n:text>
      </h3>
      <dl class="iospe">
        <dt width="150" align="left">
          <i18n:text i18n:key="epidoc-xslt-sigidoc-languages">Language(s)</i18n:text>
        </dt>
        <dd>
          <xsl:choose>
        ...
        <dt width="150" align="left">
          <i18n:text i18n:key="epidoc-xslt-sigidoc-editions">Edition(s)</i18n:text>
        </dt>
        <dd id="biblioEditions">
          <xsl:choose>
            ...
            <xsl:otherwise>
              <i>
                <i18n:text i18n:key="epidoc-xslt-sigidoc-unpublished">Unpublished</i18n:text>
              </i>
            </xsl:otherwise>
          </xsl:choose>
        </dd>
        <dt width="150" align="left">
          <i18n:text i18n:key="epidoc-xslt-sigidoc-commentary-edition">Commentary on edition(s)</i18n:text>
        </dt>
        ...
        <dt width="150" align="left">
          <i18n:text i18n:key="epidoc-xslt-sigidoc-parallels">Parallel(s)</i18n:text>
        </dt>
        <dd id="biblioParallels">
          <xsl:choose>
            ...
            <xsl:otherwise>
              <i>
                <i18n:text i18n:key="epidoc-xslt-sigidoc-no-parallels-known">No parallels known</i18n:text>
              </i>
            </xsl:otherwise>
          </xsl:choose>
        </dd>
        <dt width="150" align="left">
          <i18n:text i18n:key="epidoc-xslt-sigidoc-commentary-parallels">Commentary on parallel(s)</i18n:text>
        </dt>
      ...
      <div id="images">
        ...
        <h4 class="iospe">
          <i>
            <i18n:text i18n:key="epidoc-xslt-sigidoc-images">Images</i18n:text>
          </i>
        </h4>
      ...
      <h4 class="iospe">
        <i>
          <i18n:text i18n:key="epidoc-xslt-sigidoc-editions">Editions</i18n:text>
        </i>
      </h4>
      <div class="section-container tabs" data-section="tabs">
        <section>
          <p class="title" data-section-title="data-section-title">
            <a href="#">
              <i18n:text i18n:key="epidoc-xslt-sigidoc-interpretive">Interpretive</i18n:text>
            </a>
          </p>
        ...
        <section>
          <p class="title" data-section-title="data-section-title">
            <a href="#">
              <i18n:text i18n:key="epidoc-xslt-sigidoc-diplomatic">Diplomatic</i18n:text>
            </a>
          </p>
      ...
      <div id="apparatus" class="iospe">
        <h4 class="iospe">
          <i18n:text i18n:key="epidoc-xslt-sigidoc-apparatus">Apparatus</i18n:text>
        </h4>
      ...
      <div id="translation">
        <h4 class="iospe">
          <i>
            <i18n:text i18n:key="epidoc-xslt-sigidoc-legend-translation">Legend and Translation</i18n:text>
          </i>
        </h4>
      ...
      <div id="commentary">
        <h4 class="iospe">
          <i>
            <i18n:text i18n:key="epidoc-xslt-sigidoc-commentary">Commentary</i18n:text>
          </i>
        </h4>
      ...
      <div id="footnotes">
        <h4 class="iospe" id="notes">
          <i18n:text i18n:key="epidoc-xslt-sigidoc-footnotes">Footnotes</i18n:text>
        </h4>
        <xsl:choose>
  ...
  <xsl:template match="t:ref">
    <!-- for external (not <placeName/>) and internal links -->
    <a>
      <xsl:attribute name="href">
  ...
  <xsl:template match="t:idno[@type='PBW']">
    <!-- pointing to the boulloterion ID page on the PBW -->
    <a>
      <xsl:attribute name="href">
            ...
            <xsl:if test="$prev">
              <li class="arrow">
                <a>
                  ...
                  <i18n:text i18n:key="epidoc-xslt-sigidoc-arrow_left">
            ...
            <xsl:if test="$next">
              <li class="arrow">
                <a>
                  ...
                  <i18n:text i18n:key="epidoc-xslt-sigidoc-arrow_right">
